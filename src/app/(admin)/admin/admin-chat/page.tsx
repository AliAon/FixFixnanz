...
const ChatInterfacePage = () => {
  ...
  return (
    <div className="px-[20px]">
      <div className="px-4 py-2 bg-[#212529] text-white rounded-t-xl my-8">
        <h2 className="text-md font-roboto ">Meine Nachrichten</h2>
      </div>
      <div className="flex h-screen sm:flex-col xsm:flex-col xsm:gap-6 gap-2 bg-[#DFDFDF] px-2 py-5">
